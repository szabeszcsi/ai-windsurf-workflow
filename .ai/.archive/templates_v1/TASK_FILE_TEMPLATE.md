...
**Developer:** [Ferran/Szabi/Both]  
**Branch:** `feature/[feature-name]`  
**Timeline:** [X] phases ([Y] weeks)  
**Priority:** [HIGH/MEDIUM/LOW] - Phase [X] of project  
...
### 📋 Phase [N]: [Final Phase Name] (Week X)
...
```
I'm [Ferran/Szabi]. I'm starting [Feature] Phase [X] implementation.

Context to load:
1. Read dev[1/2]_context.md (current status + Task Constants)
2. Read docs/tasks/[feature]_phase[X]_handoff.md
3. Review 🔒 Task Constants before modifying any files

Current branch: feature/[feature-name]
Current task: Phase [X] - [Phase Name]
...
**Total Estimated Time:** [X] weeks / [Y] hours
